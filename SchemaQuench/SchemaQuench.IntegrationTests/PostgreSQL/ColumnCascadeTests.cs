...
public class ColumnCascadeTests
{
    ...
    {
        cmd.CommandText = $"SELECT COUNT(*) FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'CascColTable' AND column_name = '{columnName}'";
        return Convert.ToInt32(cmd.ExecuteScalar()) > 0;
    }

    private void DropCascColTable(System.Data.IDbCommand cmd)
    {
        cmd.CommandText = @"DROP TABLE IF EXISTS public.""CascColTable"";";
        cmd.ExecuteNonQuery();
    }
}
