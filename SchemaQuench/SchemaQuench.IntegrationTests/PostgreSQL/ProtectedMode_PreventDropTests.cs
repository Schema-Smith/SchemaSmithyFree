...
public class ProtectedMode_PreventDropTests
{
    ...
    public void ProtectedMode_RemovedCheckConstraint_NotDropped_ManifestLists_Exit0()
    {
        ...
        lock (FactoryContainer.SharedLockObject)
        {
            ...
            try
            {
                ...
                RemoveCheckConstraints(Path.Join(tempDir, "Templates", "Main", "Tables", "public.KeeperTable.json"));
    ...
    public void ProtectedMode_ModifiedCheckConstraint_IsRecreated_NotInManifest()
    {
        ...
        lock (FactoryContainer.SharedLockObject)
        {
            ...
            try
            {
                ...
                ModifyCheckExpression(Path.Join(tempDir, "Templates", "Main", "Tables", "public.KeeperTable.json"), "CK_KeeperTable_IdPos", "\"Id\" >= 0");
    ...
    {
        cmd.CommandText = $"SELECT EXISTS(SELECT 1 FROM pg_constraint WHERE conname = '{checkName}')";
        return (bool)cmd.ExecuteScalar()!;
    }
