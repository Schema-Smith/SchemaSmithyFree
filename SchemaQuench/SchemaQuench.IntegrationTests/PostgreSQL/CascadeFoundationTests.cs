...
public class CascadeFoundationTests
{
    ...
    public void TemplateTierFalse_VetoesDropEvenWhenEnvAndProductAllowDrop()
    {
        ...
        lock (FactoryContainer.SharedLockObject)
        {
            ...
            try
            {
                ...
                File.Delete(Path.Combine(tempSuppressed, "Templates", "Main", "Tables", "public.CascRemovable.json"));
                ...
                File.Delete(Path.Combine(tempEnabled, "Templates", "Main", "Tables", "public.CascRemovable.json"));
    ...
    {
        var path = Path.Combine(packageDir, "Templates", "Main", "Tables", "public.CascIdx.json");
        var json = JsonNode.Parse(File.ReadAllText(path))!.AsObject();
