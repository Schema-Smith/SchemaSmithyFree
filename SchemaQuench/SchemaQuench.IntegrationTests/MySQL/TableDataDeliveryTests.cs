        ...
        lock (FactoryContainer.SharedLockObject)
        {
            ...
            try
            {
                ...
                var quench = new DatabaseQuench("127.0.0.1", product, template, _testDb,
                    ...
                    dropRemovedTables: "0", dropRemovedColumns: "1", dropUnknownIndexes: false, updateTables: false,
        ...
        lock (FactoryContainer.SharedLockObject)
        {
            ...
            try
            {
                ...
                var quench = new DatabaseQuench("127.0.0.1", product, template, _testDb,
                    ...
                    dropRemovedTables: "0", dropRemovedColumns: "1", dropUnknownIndexes: false, updateTables: true,
                    deliverData: true, checkpointing: new FileCheckpointManager(checkpointDir));
                quench.Execute();
