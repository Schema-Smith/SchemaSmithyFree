...
public class TableQuench_IndexOnlyTests
{
    ...
    public void IndexOnlyQuench_ShouldDropUnknownIndex_WhenEnabled()
    {
        ...
        command.CommandText = $@"
            INSERT INTO `{FixtureSetup.MainDb}`.SchemaSmith_ProductOwnership (ProductName, TemplateName, ObjectSchema, ObjectType, ObjectName)
