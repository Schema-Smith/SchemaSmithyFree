...
public abstract class TableQuench_ProductLevelDropProtectionTestsSharedTests
{
    ...
    protected TableQuench_ProductLevelDropProtectionTestsSharedTests()
    {
    ...
    {
        var src = TestHelper.GetTestProductPath(ProductPlatformFolder, "DropProtection");
