...
public class SchemaShearsSubsetSafetyTests
{
    ...
    public void PatchWithAllowDropsEmpty_ProtectsOmittedTable()
    {
        ...
        lock (FactoryContainer.SharedLockObject)
        {
            ...
            try
            {
                var sourcePath = TestHelper.GetTestProductPath("SqlServer", "ShearsSource");
                ...
                File.WriteAllText(manifestFile, @"Templates\Main\Tables\dbo.ShearsKeep.json");
    ...
    {
        cmd.CommandText = @"
DROP TABLE IF EXISTS [dbo].[ShearsRemovable];
DROP TABLE IF EXISTS [dbo].[ShearsKeep];";
        cmd.ExecuteNonQuery();
    }
}
