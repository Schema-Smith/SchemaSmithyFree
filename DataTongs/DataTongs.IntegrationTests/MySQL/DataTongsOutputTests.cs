...
/// <summary>
/// Integration tests for DataTongs output functionality (content files and merge scripts).
...
public class DataTongsOutputTests
{
    ...
    public void MergeScript_NoForeignKeyChecks_InOutput()
    {
        ...
        var script = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, "country", json, "`country_id`",
            mergeUpdate: true, mergeDelete: true, disableTriggers: false,
            tokenizeScripts: false, mergeFilter: null);
    ...
    public void MergeScript_CustomKeyColumns_UsesSpecifiedKeys()
    {
        ...
        var script = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, "country", json, "`country`",
            mergeUpdate: true, mergeDelete: false, disableTriggers: false,
            tokenizeScripts: false, mergeFilter: null);
    ...
    public void GeneratedScript_CanBeExecuted()
    {
        ...
        try
        {
            ...
            var script = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, tableName, tableData, "`code`",
                mergeUpdate: true, mergeDelete: false, disableTriggers: false,
                tokenizeScripts: false, mergeFilter: null);
    ...
    public void GeneratedScript_Replace_DeletesAndInserts()
    {
        ...
        try
        {
            ...
            var script = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, tableName, tableData, "`id`",
                mergeUpdate: true, mergeDelete: true, disableTriggers: false,
                tokenizeScripts: false, mergeFilter: null);
