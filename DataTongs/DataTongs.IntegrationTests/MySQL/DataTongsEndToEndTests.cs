...
/// <summary>
/// End-to-end integration tests for DataTongs.
...
public class DataTongsEndToEndTests
{
    ...
    public void EndToEnd_ExtractAndReapply_DataMatches()
    {
        ...
        try
        {
            ...
            var keyColumns = MergeScriptHelper.GetKeyColumns(Platform.MySQL, command, _testDb, sourceTable);
            ...
            var script = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, targetTable, json, keyColumns,
    ...
    public void EndToEnd_ContentFileCanBeConsumedBySchemaQuench()
    {
        ...
        var script = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, "country", json, keyColumns,
            mergeUpdate: true, mergeDelete: false, disableTriggers: false,
            tokenizeScripts: false, mergeFilter: null);
    ...
    public void EndToEnd_RoundTrip_PreservesDecimalPrecision()
    {
        ...
        try
        {
            ...
            var script = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, tableName, json, "`id`",
    ...
    public void EndToEnd_MultipleTablesWorkflow()
    {
        ...
        var countryKeys = MergeScriptHelper.GetKeyColumns(Platform.MySQL, command, _testDb, "country");
        ...
        var cityKeys = MergeScriptHelper.GetKeyColumns(Platform.MySQL, command, _testDb, "city");
        ...
        var countryScript = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, "country", countryJson, countryKeys,
            mergeUpdate: true, mergeDelete: false, disableTriggers: false,
            tokenizeScripts: false, mergeFilter: null);
        var cityScript = MergeScriptHelper.BuildMergeScript(Platform.MySQL, command, _testDb, "city", cityJson, cityKeys,
            mergeUpdate: true, mergeDelete: false, disableTriggers: false,
            tokenizeScripts: false, mergeFilter: null);
