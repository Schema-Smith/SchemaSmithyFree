...
docker compose up
```
This spins up a SQL Server 2022 container on port **1440** and applies demo schema packages. You may also want to pull the [SchemaSmithDemos](https://github.com/Schema-Smith/SchemaSmithDemos) repository for additional demo products and examples.

Connection details are defined in `demo/.env`. Connect at `localhost:1440`.
