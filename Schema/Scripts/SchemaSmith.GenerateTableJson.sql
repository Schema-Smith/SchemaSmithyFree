...
SELECT '[' + TABLE_SCHEMA + ']' AS [Schema],
	   ...
	   (SELECT * 
          FROM (SELECT '[' + c.COLUMN_NAME + ']' AS [Name],
	                   ...
	                   '{' + (SELECT STRING_AGG('"' + [Name] + '": "' + CONVERT(NVARCHAR(MAX), [Value]) + '"', ',') FROM fn_listextendedproperty(default, 'Schema', @p_Schema, 'Table', @p_Table, 'Column', c.COLUMN_NAME) x) + '}' AS [ExtendedProperties]
       ...
       (SELECT '[' + i.[name] COLLATE DATABASE_DEFAULT + ']' AS [Name],
			   ...
			   '{' + (SELECT STRING_AGG('"' + x.[Name] + '": "' + CONVERT(NVARCHAR(MAX), [Value]) + '"', ',') FROM fn_listextendedproperty(default, 'Schema', @p_Schema, 'Table', @p_Table, 'Index', i.[Name]) x) + '}' AS [ExtendedProperties]
	   ...
	   (SELECT '[' + [Name] + ']' AS [Name],
               ...
               '{' + (SELECT STRING_AGG('"' + [Name] + '": "' + CONVERT(NVARCHAR(MAX), [Value]) + '"', ',') FROM fn_listextendedproperty(default, 'Schema', @p_Schema, 'Table', @p_Table, 'Constraint', fk.[Name]) x) + '}' AS [ExtendedProperties]
       ...
       (SELECT '[' + [Name] + ']' AS [Name], 
			   ...
			   '{' + (SELECT STRING_AGG('"' + [Name] + '": "' + CONVERT(NVARCHAR(MAX), [Value]) + '"', ',') FROM fn_listextendedproperty(default, 'Schema', @p_Schema, 'Table', @p_Table, 'Statistic', s.[Name]) x) + '}' AS [ExtendedProperties]
       ...
       (SELECT '[' + [Name] + ']' AS [Name],
               ...
               '{' + (SELECT STRING_AGG('"' + [Name] + '": "' + CONVERT(NVARCHAR(MAX), [Value]) + '"', ',') FROM fn_listextendedproperty(default, 'Schema', @p_Schema, 'Table', @p_Table, 'Constraint', cc.[Name]) x) + '}' AS [ExtendedProperties]
	   ...
	   '{' + (SELECT STRING_AGG('"' + [Name] + '": "' + CONVERT(NVARCHAR(MAX), [Value]) + '"', ',') FROM fn_listextendedproperty(default, 'Schema', @p_Schema, 'Table', @p_Table, default, default) x) + '}' AS [ExtendedProperties]
