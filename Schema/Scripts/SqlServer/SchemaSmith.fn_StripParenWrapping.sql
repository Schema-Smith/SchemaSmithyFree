...
IF OBJECT_ID('SchemaSmith.fn_StripParenWrapping') IS NOT NULL DROP FUNCTION SchemaSmith.fn_StripParenWrapping
GO
CREATE FUNCTION SchemaSmith.fn_StripParenWrapping(@p_Input NVARCHAR(MAX))
