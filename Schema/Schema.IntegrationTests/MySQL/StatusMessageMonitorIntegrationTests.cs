...
/// <summary>
/// Integration tests for StatusMessageMonitor against a live MySQL database.
/// Verifies that the monitor can capture messages written by stored procedures.
/// </summary>
[Category("MySQL")]
[TestFixture]
[Category("Integration")]
public class StatusMessageMonitorIntegrationTests
{
    ...
    public void StatusMessageMonitor_CapturesMessages_WrittenByOtherConnection()
    {
        ...
        using var monitor = new StatusMessageMonitor(
            FixtureSetup.GetMainDbConnectionString(),
            _sessionId,
