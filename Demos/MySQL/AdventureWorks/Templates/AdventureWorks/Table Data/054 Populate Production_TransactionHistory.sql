SET @json_data = '{{Production_TransactionHistory.tabledata}}';

INSERT INTO `adventureworks`.`Production_TransactionHistory` (`ActualCost`, `ModifiedDate`, `ProductID`, `Quantity`, `ReferenceOrderID`, `ReferenceOrderLineID`, `TransactionDate`, `TransactionID`, `TransactionType`)
