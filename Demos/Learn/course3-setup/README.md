...
databases on every sandbox engine (SQL Server, PostgreSQL, MySQL) — nine databases in total. They
support the multi-environment promotion labs in Course 3.
...
Both scripts print `PASS` or `FAIL` for each of the nine databases:
